...
const AppPreview = () => {
   ...
   return (
      <section
         ...
         style={{ background: '#fff', position: 'relative', overflow: 'hidden', fontFamily: 'var(--font-body)' }}
      >
         ...
         <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 10 }}>
            ...
            <div style={{ textAlign: 'center', maxWidth: 680, margin: '0 auto 60px' }}>
               ...
               <motion.h2
                  ...
                  style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(2.2rem, 5vw, 4.5rem)', fontWeight: 800, color: '#0f172a', lineHeight: 1.05, letterSpacing: '-0.03em' }}
               >
                  Find. Charge. Monitor.<br />
                  <span style={{ color: '#16a34a' }}>Total control.</span>
               </motion.h2>
            </div>

            {/* 3D Ecosystem Stage */}
            <div style={{ position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center' }} className="min-h-[540px] md:min-h-[640px] lg:min-h-[720px]">

               <motion.div
                  style={{ rotateX, rotateY, transformStyle: 'preserve-3d', transformPerspective: 1200, position: 'relative' }}
                  className="scale-[0.75] md:scale-90 lg:scale-100"
               >
                  {/* Phone Shadow */}
